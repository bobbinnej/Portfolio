...
export default function About({}: Props) {
  return (
    ...
    mx-auto items-center'>
      ...
      md:rounded-lg md:w-[250px] md:h-[300px] xl:w-[450px] xl:h-[400px] xl:mt-70 md:mb-20'
        />

        <div className='space-y-8 px-0 md:px-10 '>
          <h4 className='text-sm font-semibold xl:text-4xl md:text-2xl mb-2 mt-8'>A little <span className='underline decoration-[#F7A]/40'>background</span> about me</h4>
