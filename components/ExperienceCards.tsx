...
export default function ExperienceCards({}: Props) {
  ...
  overflow-hidden w-80  mt-36 xl:mt-[300px] xl:w-[400px] md:w-[792px]  md:h-[600px]"
    >
      <motion.img
        initial={{
          opacity: 0,
        ...
        className="h-28 w-28 rounded-full object-cover xl:w-[140px] xl:h-[140px] object-center mx-[25%]
      ...
      <div className=" md:mx-[50px] md:flex-wrap xl:flex-wrap ml-10  flex-wrap">
        ...
        <ul className="list-disc space-y-2 ml-5 xl:text-lg md:text:lg text-sm flex-wrap">
